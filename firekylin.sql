...
# Dump of table ${db_prefix}category
# ------------------------------------------------------------
...
/*!40000 ALTER TABLE `${db_prefix}category` DISABLE KEYS */;

INSERT INTO `${db_prefix}category` (`id`, `name`)
VALUES
	(25,'ES6'),
	(26,'React'),
	(28,'nodejs'),
...
/*!40000 ALTER TABLE `${db_prefix}category` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table ${db_prefix}config
# ------------------------------------------------------------
...
LOCK TABLES `${db_prefix}config` WRITE;
/*!40000 ALTER TABLE `${db_prefix}config` DISABLE KEYS */;

INSERT INTO `${db_prefix}config` (`key`, `value`)
VALUES
	('author','陈凯'),
...
/*!40000 ALTER TABLE `${db_prefix}config` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table ${db_prefix}imghash
# ------------------------------------------------------------

DROP TABLE IF EXISTS `${db_prefix}imghash`;

CREATE TABLE `${db_prefix}imghash` (
...
LOCK TABLES `${db_prefix}imghash` WRITE;
/*!40000 ALTER TABLE `${db_prefix}imghash` DISABLE KEYS */;

INSERT INTO `${db_prefix}imghash` (`id`, `basename`, `md5`)
VALUES
...
/*!40000 ALTER TABLE `${db_prefix}imghash` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table ${db_prefix}post
# ------------------------------------------------------------
...
LOCK TABLES `${db_prefix}post` WRITE;
/*!40000 ALTER TABLE `${db_prefix}post` DISABLE KEYS */;

INSERT INTO `${db_prefix}post` (`id`, `user_id`, `category_id`, `title`, `content`, `date`, `status`, `modify_date`, `modify_user_id`)
VALUES
...
# Dump of table ${db_prefix}post_tag
# ------------------------------------------------------------
...
LOCK TABLES `${db_prefix}post_tag` WRITE;
/*!40000 ALTER TABLE `${db_prefix}post_tag` DISABLE KEYS */;

INSERT INTO `${db_prefix}post_tag` (`id`, `post_id`, `tag_id`, `status`)
VALUES
	(41,166,5,1),
	(42,166,4,1);

/*!40000 ALTER TABLE `${db_prefix}post_tag` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table ${db_prefix}tag
# ------------------------------------------------------------
...
LOCK TABLES `${db_prefix}tag` WRITE;
/*!40000 ALTER TABLE `${db_prefix}tag` DISABLE KEYS */;
...
INSERT INTO `${db_prefix}user` (`id`, `username`, `password`, `nickname`, `email`, `group`, `status`, `add_time`, `add_ip`, `last_login_time`, `last_login_ip`, `login_count`)
VALUES
